...
export PATH=/usr/local/bin:/usr/local/sbin:/usr/bin:/bin:/usr/sbin:/sbin:/usr/texbin:/Library/PostgreSQL/8.4/bin:/Users/keeds/bin:/usr/local/texlive/2012basic/bin/universal-darwin:/usr/local/Cellar/ruby/2.1.0/bin
